...
Priority 2 завершён ✅, Priority 3 — **в работе**.
...
- ✅ MEDIA-8: E2E передача файлов Android — XSalsa20 через lazysodium, Coil EncryptedMediaFetcher, inline изображения, карточка скачивания, DB schema v2
  - Ветка: `feat/priority3-android-file-transfer`
...
**Передача файлов Android** (`apps/mobile/android/`) ✅ **ЗАВЕРШЕНО** — влить ветку `feat/priority3-android-file-transfer` в main

**Передача файлов Desktop** (`apps/desktop/`)
- По аналогии с Android после завершения Android-части
